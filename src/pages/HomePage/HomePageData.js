...
export const homeObjOfer3 = {
  ...
  lightText: false,
  lightTextDesc: false,
  topLine: 'Współpraca projektowa',
  headline: 'Wsparcie dla Frontendu',
  description:"Realizujesz projekt i potrzebujesz programisty frontendowca do współpracy? Mogę dołączyć do Twojego zspołu. Pomogę zaimplementować projekt graficzny. Wykorzystuję CSS/SASS oraz JS i React. Na codzień pracuję z Wordpress-em i Elementorem. Odwiedź moje konto na GitHub.",
  buttonLabel: 'KONTAKT',
  anchor: '#s5',
  imgStart: 'start',
  img: require('../../images/stack-html-css-js.svg').default,
  alt: 'WebDeveloper współpraca przy projektach programistycznych',
  start: 'true',
  doNotShow: true,
  doNotShow1: true,
  doNotShow2: false,
...
export const homeObj500 = {
  ...
  lightText: true,
  lightTextDesc: true,
  topLine: 'polecaj </>insCODE',
  headline: '...i zgarnij 500 zł',
  description:
    "Polecając moje usługi możesz zgarnąć 500 zł w gotówce. Jak to działa? Opowiedz znajomym, klientom osobom szukającym webdevelopera o mnie. Za każdą osobę, która złoży i opłaci zamówienie możesz odebrać 500 zł nagrody. Wystarczy, tylko jej potwierdzenie, że to właśnie Ty mnie zareklamowałeś. To komu już o mnie opowiedziałeś? ;)",
  buttonLabel: '',
  imgStart: true,
  img: require('../../images/portfel.svg').default,
  alt: 'insCASHBACK',
  start: '',
  doNotShow: true,
  doNotShow1: true,
